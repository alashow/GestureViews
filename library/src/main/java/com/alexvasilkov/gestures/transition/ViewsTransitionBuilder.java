...
import com.alexvasilkov.gestures.transition.internal.FromSingleImageViewListener;
...
public class ViewsTransitionBuilder<ID> {
    ...
    public ViewsTransitionBuilder<ID> fromSingleImageView(@NonNull ImageView imageView,
                                                          @NonNull ViewsTracker<ID> tracker) {
        animator.setFromListener(new FromSingleImageViewListener<>(imageView, tracker, animator));
        return this;
    }
